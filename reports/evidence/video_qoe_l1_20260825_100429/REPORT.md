...
- 采集时间：2026-08-25T10:04:29+08:00
- 采集时长：178.6 s
...
|---|---:|
| 下行平均吞吐 | 0.012 Mbit/s |
| 下行峰值吞吐（实际平均采样间隔 1.49 s） | 0.500 Mbit/s |
| 下行 P5 / P50 / P95 | 0.000 / 0.001 / 0.037 Mbit/s |
| 波动幅度 P95-P5 | 0.037 Mbit/s |
| 标准差 / 变异系数 CV | 0.056 Mbit/s / 4.616 |
| 5 秒窗口 P5 / P50 / P95 | 0.001 / 0.002 / 0.069 Mbit/s |
...
- ICMP RTT 均值 / P95 / 相邻样本抖动：61.73 / 101.15 / 40.58 ms。
- 蜂窝接口 RX/TX dropped 增量：0/0；errors 增量：0/0。
- Wi-Fi 驱动 RX/TX dropped 增量：623/72。该 MTK 驱动计数可能包含无线失败/重试，不能直接当作端到端 IP 丢包率。
