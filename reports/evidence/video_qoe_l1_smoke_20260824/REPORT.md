...
- 采集时间：2026-08-25T09:56:18+08:00
- 采集时长：7.4 s
...
|---|---:|
| 下行平均吞吐 | 0.006 Mbit/s |
| 下行峰值吞吐（1 s 粒度） | 0.025 Mbit/s |
| 下行 P5 / P50 / P95 | 0.000 / 0.000 / 0.021 Mbit/s |
| 波动幅度 P95-P5 | 0.021 Mbit/s |
| 标准差 / 变异系数 CV | 0.010 Mbit/s / 1.793 |
| 5 秒窗口 P5 / P50 / P95 | 0.008 / 0.008 / 0.008 Mbit/s |
| Wi-Fi 信号均值 / 最差 | -69.0 / -69.0 dBm |
...
- ICMP RTT 均值 / P95 / 相邻样本抖动：51.21 / 89.62 / 31.93 ms。
- 蜂窝接口 RX/TX dropped 增量：0/0；errors 增量：0/0。
- Wi-Fi 驱动 RX/TX dropped 增量：34/4。该 MTK 驱动计数可能包含无线失败/重试，不能直接当作端到端 IP 丢包率。
